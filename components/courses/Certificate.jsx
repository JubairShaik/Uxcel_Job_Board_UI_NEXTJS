    ...
    <div className="bg-violet-200 p-[24px]  mb-14 bg-blue-600 flex  h-full  items-center md:items-start flex-row md:flex-col rounded-2xl  w-full   shadow-md">
      <div>
        <div className="flex items-center gap-3 justify-center">
          ...
          <h2 className="lg:text-xl text-xl font-normal sm:font-semibold text-gray-800">
        ...
        <button className=" px-5  rounded-md py-2 text-white  w-full text-sm  md:text-lg font-semibold bg-violet-500">
